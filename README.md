...
* [AVML](https://github.com/microsoft/avml) ⭐ 1,120 | 🐛 8 | 🌐 Rust | 📅 2026-09-17 - AVML is an X86\_64 userland volatile memory acquisition tool written in Rust, intended to be deployed as a static binary.
...
* [PCILeech](https://github.com/ufrisk/pcileech) ⭐ 7,920 | 🐛 9 | 🌐 C | 📅 2026-07-25 - PCILeech uses PCIe hardware devices to read and write target system memory. This is achieved by using DMA over PCIe. No drivers are needed on the target system.
...
* [Volatility3](https://github.com/volatilityfoundation/volatility3) ⭐ 4,402 | 🐛 138 | 🌐 Python | 📅 2026-09-17 - Volatility is the world's most widely used framework for extracting digital artifacts from volatile memory (RAM) samples.
* [MemProcFS](https://github.com/ufrisk/MemProcFS) ⭐ 4,336 | 🐛 6 | 🌐 C | 📅 2026-09-14 - The Memory Process File System (MemProcFS) is an easy and convenient way of viewing physical memory as files in a virtual file system.
...
* [MemLabs](https://github.com/stuxnet999/MemLabs) ⭐ 1,899 | 🐛 0 | 🌐 Shell | 📅 2021-03-08
* Digital Corpora
